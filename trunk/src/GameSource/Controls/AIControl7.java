...
public class AIControl7 extends AIControl {
    ...
    public AIControl7(GameMap map, double _aggroRadius, int _delay, double _attack1Range, int _attack1Delay) {
        super(new CowAICalculation());
        curMap = map;
    ...
    public void update(Object returnValue) {
        ...
        if ((!isAttacking && slow == delay) || slow == attack1Delay) {
